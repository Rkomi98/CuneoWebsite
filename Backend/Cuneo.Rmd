...
styled_table <- table_data %>%
  ...
  column_spec(2, 
              background = case_when(
                (table_data$player_name == "Serena Scognamillo" | table_data$player_name == "Federica Ferrario") ~ ifelse(table_data$efficienza >= 0.56, "lightgreen", ifelse(table_data$efficienza > 0.48 & table_data$efficienza < 0.56, "yellow", "lightcoral")),
                (table_data$player_name == "Lena Stigrot" | table_data$player_name == "Anna Haak") ~ ifelse(table_data$efficienza >= 0.37, "lightgreen", ifelse(table_data$efficienza > 0.31 & table_data$efficienza < 0.37, "yellow", "lightcoral")),
                (table_data$player_name == "Alice Tanase" | table_data$player_name == "Madison Kubik") ~ ifelse(table_data$efficienza >= 0.43, "lightgreen", ifelse(table_data$efficienza > 0.37 & table_data$efficienza < 0.43, "yellow", "lightcoral")),
                TRUE ~ ifelse(table_data$efficienza >= 0.42, "lightgreen", ifelse(table_data$efficienza > 0.41 & table_data$efficienza < 0.42, "orange", "red"))
              )
              )
...
total_stats <- table_data %>%
  summarise(
    ...
    count_positive = sum(count_positive),
    count_errori = sum(count_errori),
    positività = sum(count_positive + count_perfette) / sum(N_attacks),
    efficienza = sum(count_positive + count_perfette - count_errori) / sum(N_attacks)
  )
...
styled_table <- table_data %>%
  ...
  column_spec(2, background = case_when(
                (table_data$player_name == "Anna Adelusi" | table_data$player_name == "Terry Ruth Enweonwu") ~ ifelse(table_data$efficienza >= 0.27, "lightgreen", ifelse(table_data$efficienza > 0.24 & table_data$efficienza < 0.27, "yellow", "lightcoral")),
                (table_data$player_name == "Anna Haak" | table_data$player_name == "Lena Stigrot") ~ ifelse(table_data$efficienza >= 0.34, "lightgreen", ifelse(table_data$efficienza > 0.30 & table_data$efficienza < 0.34, "yellow", "lightcoral")),
                (table_data$player_name == "Alice Tanase" | table_data$player_name == "Madison Kubik") ~ ifelse(table_data$efficienza >= 0.24, "lightgreen", ifelse(table_data$efficienza > 0.20 & table_data$efficienza < 0.24, "yellow", "lightcoral")),
                (table_data$player_name == "Saly Thior" | table_data$player_name == "Amandha Sylves" | table_data$player_name == "Anna Hall" | table_data$player_name == "Beatrice Molinaro") ~ ifelse(table_data$efficienza >= 0.44, "lightgreen", ifelse(table_data$efficienza > 0.38 & table_data$efficienza < 0.44, "yellow", "lightcoral")),
                TRUE ~ ifelse(table_data$efficienza >= 0.42, "lightgreen", ifelse(table_data$efficienza > 0.41 & table_data$efficienza < 0.42, "orange", "red"))
              )
              )
