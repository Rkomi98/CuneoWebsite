...
table_data <- px %>% 
  ...
  dplyr::summarize(
    ...
    positività = percent((count_positive + count_perfette)/N_battute),
    efficienza = percent((count_positive + count_perfette - count_errori)/N_battute),
  )
...
team_total <- table_data %>%
  summarise(
    ...
    positività = percent(sum(count_positive + count_perfette) / sum(N_battute)),
    efficienza = percent(sum(count_positive + count_perfette - count_errori) / sum(N_battute))
  ) %>%
...
table_data <- px %>% 
  ...
  dplyr::summarize(
    ...
    #count_negative = sum(evaluation_code == "-", na.rm = TRUE),
    count_errori = sum(evaluation_code == "=", na.rm = TRUE),
    positività = percent((count_positive + count_perfette)/N_receptions),
    efficienza = percent((count_positive + count_perfette - count_errori)/N_receptions),
  )
...
table_data <- px %>% 
  ...
  dplyr::summarize(
    ...
    #count_negative = sum(evaluation_code == "-", na.rm = TRUE),
    count_errori = sum(evaluation_code == "=", na.rm = TRUE),
    positività = percent((count_positive + count_perfette)/N_attacks),
    efficienza = percent((count_positive + count_perfette - count_errori)/N_attacks),
  )
